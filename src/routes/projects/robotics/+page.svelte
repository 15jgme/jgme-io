...
<div class="text-sm md:text-base font-mono transition-all">
	<title>Robotics Projects</title>
	<body>
		<div class="tabs justify-center">
			<a class="tab md:tab-lifted" href="/projects/software_development">Software</a>
			<a class="tab md:tab-lifted tab-active" href="/projects/robotics">		<div class="flex">
				<svg
				...
				<h2 class="font-extrabold text-xl md:text-2xl inline">Robotics projects</h2>
			</div></a>
