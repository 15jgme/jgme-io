...
<div class="flex flex-col h-screen justify-between">
	...
	<footer class="transition-all py-5 flex space-x-9/16">
		...
		<ul class="flex justify-end font-mono text-gray-800 transition-all">
			<li class="mr-6 p-2 rounded-2xl hover:scale-110">
				<a href="https://github.com/15jgme/"
					><svg
						width="98"
						height="96"
						class="h-14 w-14"
			...
			<li class="mr-6 p-2 rounded-2xl hover:scale-110">
				<a href="https://gitlab.com/15jgme/">
					<svg xmlns="http://www.w3.org/2000/svg" class="h-14 w-14" viewBox="40 40 300 300"
						><defs
							><style>
								.cls-1 {
									fill: #171321;
